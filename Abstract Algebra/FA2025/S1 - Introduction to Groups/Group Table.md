> Def. (Group/Multiplication Table): Let $G = \{g_{1}, \ldots, g_{n}\}$ be a finite group with $g_{1} = 1$. The *multiplication table* or *group table* of $G$ is the $n\times n$ matrix whose $i, j$ entry is the group element $g_{i} g_{j}$. 
